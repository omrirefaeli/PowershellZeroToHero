...
$questions = @(
    ...
    [Question]::new(6, 'code', 'How many available commands in your machine has "Microsoft.PowerShell.Utility" as ther ModuleName (No Aliases!)?', { $(Get-command | Where-Object{$_.ModuleName -eq "Microsoft.PowerShell.Utility"}).Count },'' ,"It will probably be best to add `| Where-object <add some stuff here>` to the Get-Command output"),
